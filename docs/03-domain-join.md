...
Подключить Linux-сервер к Active Directory и разрешить доступ только согласованным пользователям или группам.
...
Рекомендуется для обычной аутентификации Linux-пользователей через Active Directory.
